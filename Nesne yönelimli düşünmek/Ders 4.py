#__init__metodu: ilgili class'tan bir nesne oluştuğunda çalışır.
#self parametresi: oluşturulan nesneye referans olarak verir.
...
class Book:
    ...
    def __str__(self):
        return f"Kitap: {self.name} - Yazar: {self.author} - Yayınevi: {self.publisher}"
